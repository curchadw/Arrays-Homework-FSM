...
const food = (item) =>{
  //If the item already exist in the array, it will not duplicate the item in the array
...
//I created a function that check to see if a third item exist in the array account for both exisiting and not exisitng 
const thirdItem = () =>{
